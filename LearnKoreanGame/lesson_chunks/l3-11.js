...
window.lessonGuideL3LessonChunks["l3-11"] = {
    ...
    "practice": [
        ...
        },
        {
            "type": "grammar",
            "title": "-다체로 바꾸기",
            "prompt": "“교통이 편리합니다”를 객관적인 글의 문체로 바꾸세요.",
            "answer": "교통이 편리하다."
        },
        {
            "type": "speaking",
            "title": "부동산에서 조건 말하기",
            "prompt": "방 두 개, 월세, 지하철역 가까움 조건으로 집을 찾아 달라고 말해 보세요.",
        ...
        },
        {
            "type": "reading",
            "title": "계약 안전 확인",
            "prompt": "계약할 때 등기부등본을 확인해야 하는 이유는 무엇입니까?",
            "answer": "계약하는 사람이 실제 집주인인지 확인하고 보증금 피해를 막기 위해서입니다."
        },
        {
            "type": "culture",
            "title": "공유 주택 이해",
            "prompt": "공유 주택이 사회 초년생에게 인기 있는 이유를 두 가지 말해 보세요.",
            "answer": "월세가 싸고 계약 기간이 짧습니다. 또 다른 사람들과 대화하거나 취미 활동을 함께할 수 있습니다."
        },
        {
            "type": "writing",
            "title": "살고 싶은 집 쓰기",
            "prompt": "위치, 형태, 구조, 주변 환경을 넣어 세 문장으로 써 보세요.",
